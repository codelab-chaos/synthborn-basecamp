...
Kamu mungkin bertanya-tanya apa arti "int". Itu adalah tipe data primitif di Java. Java has 8 primitive and non-primitive (reference) data types.
You will learn the difference between them later. Berikut adalah yang paling penting untuk modding:
