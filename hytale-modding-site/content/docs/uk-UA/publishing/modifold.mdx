...
# Інтеграція з HytaleModding Wiki

Якщо ваша модифікація використовує [HytaleModding Wiki](https://wiki.hytalemodding.dev), просто додайте посилання на вікі в налаштуваннях проєкту Modifold.

Після цього ваш проєкт матиме вкладку **Wiki** з синхронізованими сторінками й вмістом Markdown.

Налаштування та редагування вікі залишаються на вебсайті [HytaleModding Wiki](https://wiki.hytalemodding.dev).

![](/assets/guides/modifold_project_wiki.png)

На знімку екрану вище показано сторінку вікі проєкту Voile: [modifold.com/mod/voile/wiki](https://modifold.com/mod/voile/wiki)
