...
description: Uma introdução baseada nas informações disponíveis sobre o sistema de visual scripting do Hytale.
---

# Introdução

O Hytale pretende implementar a visual scripting como uma ferramenta para expandir o acesso a lógicas complexas e fluxos de controle para um público mais amplo. Esse sistema não estará disponível no lançamento, mas deve chegar em seguida.
