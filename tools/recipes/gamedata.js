 ...
 *   docs/recipes/recipes.json   (node tools/recipes/extract-recipes.js)
 *   docs/recipes/loot.json      (node tools/recipes/extract-loot.js)
 ...
 *
 * Examples:
 *   node tools/recipes/gamedata.js bench Campfire
 ...
 *   node tools/recipes/gamedata.js find Tannery
 *
...
const RECIPES_FILE = path.join(REPO_ROOT, "docs", "recipes", "recipes.json");
const LOOT_FILE = path.join(REPO_ROOT, "docs", "recipes", "loot.json");
...
function loadRecipes() {
  return loadJson(RECIPES_FILE, "node tools/recipes/extract-recipes.js");
}
function loadLoot() {
  return loadJson(LOOT_FILE, "node tools/recipes/extract-loot.js");
}
...
Usage: node tools/recipes/gamedata.js <command> <id> [--json]
...
Data comes from docs/recipes/{recipes,loot}.json — regenerate with
