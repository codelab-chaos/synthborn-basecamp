 ...
 *
 * Usage:
 *   node tools/recipes/extract-recipes.js [--assets <dir>] [--out <dir>]
 */
...
function usage() {
  console.log(`Usage: node tools/recipes/extract-recipes.js [options]
...
function renderText({ recipes, byInput, byOutput, generatedAt }) {
  ...
  lines.push("");
  lines.push("Regenerate: `node tools/recipes/extract-recipes.js`");
  lines.push("");
