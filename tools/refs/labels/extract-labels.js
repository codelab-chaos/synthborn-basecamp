 ...
 *
 * Emits:
 *   docs/refs/labels/labels.json   structured index (items, resourceTypes, npcRoles, byName)
 *   docs/refs/labels/labels.txt    grep-friendly id → name lines
 *
 * Usage:
 *   node tools/refs/labels/extract-labels.js [--assets <dir>] [--out <dir>]
 */
...
const DEFAULT_OUT = path.join(REPO_ROOT, "docs", "refs", "labels");
...
function usage() {
  console.log(`Usage: node tools/refs/labels/extract-labels.js [--assets <dir>] [--out <dir>]`);
}
