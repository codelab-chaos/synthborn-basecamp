 ...
 *
 * Usage:
 *   node tools/refs/recipes/extract-bench-tiers.js [--assets <dir>] [--out <dir>]
 */
...
function usage() {
  console.log(`Usage: node tools/refs/recipes/extract-bench-tiers.js [options]

  --assets <dir>   _Assets root (default: <repo>/_Assets)
  --out <dir>      output dir   (default: <repo>/docs/refs/recipes)
...
function renderText(benches, generatedAt) {
  ...
  lines.push("");
  lines.push("Regenerate: `node tools/refs/recipes/extract-bench-tiers.js`");
  lines.push("");
