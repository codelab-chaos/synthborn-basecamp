...
function buildMethodIndex({ outDir = DEFAULT_REF_DIR, quiet = false, version } = {}) {
  ...
  fs.writeFileSync(jsonPath, `${JSON.stringify({
    ...
    generatedBy: "tools/refs/sdk/build-sdk-method-index.js",
  ...
  const txtLines = [
    ...
    "Regenerate: `node tools/refs/sdk/build-sdk-method-index.js` (or full extract — see tools/refs/sdk/README.md)",
    "",
  ];
...
if (require.main === module) {
  try {
    ...
    if (opts.help) {
      console.log("Usage: node tools/refs/sdk/build-sdk-method-index.js [--out <dir>]");
      process.exit(0);
    }
