 ...
 *
 * Usage:
 *   node tools/overseer/extract-prefab-modules.js
 *   node tools/overseer/extract-prefab-modules.js --root _references/example-prefabs
 *   node tools/overseer/extract-prefab-modules.js --json-out docs/procbuild/reference-prefab-modules.json
 *   node tools/overseer/extract-prefab-modules.js --md-out docs/procbuild/reference-prefab-modules.md
 */
...
function parseArgs(argv) {
  ...
  for (let i = 2; i < argv.length; i++) {
    ...
    if (a === "--root") opts.root = path.resolve(argv[++i]);
      ...
      console.log("Usage: node tools/overseer/extract-prefab-modules.js [--root PATH] [--json-out FILE] [--md-out FILE]");
      process.exit(0);
    } else {
...
function markdown(catalog) {
  ...
  lines.push("");
  lines.push(`Generated by \`tools/overseer/extract-prefab-modules.js\` on ${catalog.generated_at}.`);
  lines.push("");
...
function main() {
  ...
  const catalog = {
    ...
    schema: "synthoverseer.reference_prefab_modules.v1",
