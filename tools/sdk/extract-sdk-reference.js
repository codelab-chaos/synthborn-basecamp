 ...
 * file per package under docs/sdk-reference/, plus an index.
 *
...
function renderPackage(jar, pkg, purpose) {
  ...
  header.push("");
  header.push(`Auto-generated by [tools/sdk/extract-sdk-reference.js](../../tools/sdk/extract-sdk-reference.js). Do not edit by hand — regenerate on SDK updates.`);
  header.push("");
  header.push("---");
  header.push("");
...
function main() {
  ...
  const outDir = opts.out
    ...
    : path.resolve(__dirname, "..", "..", "docs", "sdk-reference");
