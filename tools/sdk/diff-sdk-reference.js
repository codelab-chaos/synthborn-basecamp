 ...
 *
 * Usage:
 *   node tools/sdk/diff-sdk-reference.js                    # vs git HEAD
 *   node tools/sdk/diff-sdk-reference.js --against main
 *   node tools/sdk/diff-sdk-reference.js --against ../old-sdk-reference
 */
...
function usage() {
  console.log(`Usage:
  node tools/sdk/diff-sdk-reference.js [--against <git-ref|dir>] [--out <dir>]

Compares the current docs/sdk-reference tree to:
