# MountainForestAtmosphere.json

- Path: `worldgenV2/generated/Biomes/Experimental/MountainForestAtmosphere.json`
- Asset name: `MountainForestAtmosphere`
- Root type: `Biome`
...
- WARN: External import `Plains1_Mountains_Grasses` must exist in the active worldgen/framework context.
- WARN: External import `Plains1_Mountains_Trees` must exist in the active worldgen/framework context.
...
- 0: (unknown) assignments={Type:Imported, Name:Plains1_Mountains_Grasses}
- 1: (unknown) assignments={Type:Imported, Name:Plains1_Mountains_Trees}
