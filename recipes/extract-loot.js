 ...
 *
 * Usage:
 *   node tools/recipes/extract-loot.js [--assets <dir>] [--out <dir>] [--verbose]
 */
...
function usage() {
  console.log(`Usage: node tools/recipes/extract-loot.js [options]
...
function renderText({ droplists, blocks, byItem, generatedAt }) {
  ...
  lines.push("");
  lines.push("`x<n>~` is the mean count per resolution; `(p%)` is P(at least one). Query with `node tools/recipes/gamedata.js drops <id>` / `source <item>`.");
  lines.push("");
  lines.push("Regenerate: `node tools/recipes/extract-loot.js`");
  lines.push("");
