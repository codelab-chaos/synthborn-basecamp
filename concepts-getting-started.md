...
| Asset | Role |
|---|---|
| **[HyCitizens](./HyCitizens/)** | Persistent NPCs — schedules, patrol, combat, groups, animations, interactions |
| **[NPCTrading](./NPCTrading/)** | Merchant/trade layer — companion-plugin pattern for extending HyCitizens |
| **[LLM_NPC_ROLEPLAY.md](./LLM_NPC_ROLEPLAY.md)** | Design for `HyCitizensAI` — LLM chat, cross-NPC talk, memory + tasks |
| **[research-erenshor-npcs.md](./research-erenshor-npcs.md)** | Why believability beats intelligence; Erenshor's SimPlayer model |
| **[research-behavior-trees.md](./research-behavior-trees.md)** | Data-driven BT design, blackboard, testing |
| **[research-advanced-npc-techniques.md](./research-advanced-npc-techniques.md)** | Utility AI, GOAP, smart objects, A-Life, hybrid stacks |
| **[hytale-test-automation.md](./hytale-test-automation.md)** | Test pyramid, FakePlayer spike, Actor abstraction |
...
2. **Deterministic systems drive 99% of behavior.** LLM is for flavor dialogue and rare "interesting moments," cached and budgeted aggressively. See [research-erenshor-npcs.md](./research-erenshor-npcs.md).
...
Build in this order (from [research-advanced-npc-techniques.md](./research-advanced-npc-techniques.md)):
...
See [research-behavior-trees.md](./research-behavior-trees.md) for design, maintenance, and deterministic tick testing.
...
From [LLM_NPC_ROLEPLAY.md](./LLM_NPC_ROLEPLAY.md):
...
Never call the LLM every tick. Split brain from body ([hytale-test-automation.md](./hytale-test-automation.md)):
...
Run the **FakePlayer action spike** (chat → move → attack → break/place block) before committing to companion agents. See [hytale-test-automation.md § B.6](./hytale-test-automation.md).
...
- `LLM_NPC_ROLEPLAY.md` § 4–5 — persona model and Phase 1 flow
...
5. **Smart objects / affordances** — tag blocks/entities (forge, bed, chair, market stall) so NPCs query "what can I do here?" instead of hardcoding every location. Ideal for Hytale's block world ([research-advanced-npc-techniques.md](./research-advanced-npc-techniques.md)).
...
|---|---|
| [research-erenshor-npcs.md](./research-erenshor-npcs.md) | Understanding the "living world" target and Erenshor's specific techniques |
| [research-behavior-trees.md](./research-behavior-trees.md) | Designing and testing NPC decision logic |
| [research-advanced-npc-techniques.md](./research-advanced-npc-techniques.md) | Choosing utility AI, GOAP, smart objects, A-Life for village scale |
| [LLM_NPC_ROLEPLAY.md](./LLM_NPC_ROLEPLAY.md) | Full HyCitizensAI plugin design — persona model, phases, capability catalog |
| [hytale-test-automation.md](./hytale-test-automation.md) | Test pyramid, Actor abstraction, FakePlayer spike |
| [HyCitizens README](./HyCitizens/README.md) | In-game NPC management; [docs](https://hycitizens.com/docs) for API |
| [NPCTrading README](./NPCTrading/README.md) | Trader API and HyCitizens integration pattern |
