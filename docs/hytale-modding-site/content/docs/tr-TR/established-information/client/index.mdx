...
<Callout>
The client is written in C#, compiled to machine code before distribution, and not moddable. Tek oyunculu mod, yerel bir sunucu üzerinde çalışır. All mods must go through the server API.
</Callout>
