...
The seam (from `_mod-example-sourcecode/NPCTrading/.../TraderInteraction.java`):
...
- In-repo references: `_mod-example-sourcecode/HyCitizens/.../Template_Citizen.json` (role/instruction example), `_mod-example-sourcecode/NPCTrading/.../TraderInteraction.java` (companion-plugin integration pattern), `_mod-example-sourcecode/HyCitizens/.../SkinUtilities.java` (async `HttpClient` pattern).
</content>
</invoke>
